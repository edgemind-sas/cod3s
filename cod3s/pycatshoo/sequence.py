...
class PycSequence(pydantic.BaseModel):
    # Parametres
    probability: float = pydantic.Field(None,
                                        description="Sequence probability")
     
    nb_occurrences: int = pydantic.Field(None,
                                         description="Sequence occurrence number")
     
    target_event: str = pydantic.Field(None, description="Target event")
     
    transitions: typing.List[PycTransition] = \
        pydantic.Field([], description="Liste de transition")
